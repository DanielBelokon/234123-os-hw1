...
SRCS := Commands.cpp signals.cpp smash.cpp BuiltInCommands.cpp JobsList.cpp ExternalCommands.cpp SmallShell.cpp
OBJS=$(subst .cpp,.o,$(SRCS))
HDRS := Commands.h signals.h BuiltInCommands.h JobsList.h ExternalCommands.h SmallShell.h
